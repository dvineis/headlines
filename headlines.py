...
WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather?q={}&units=metric&appid=85182c33197d1f4f6c7cf696c7512ea7"
CURRENCY_URL = "https://openexchangerates.org//api/latest.json?app_id=73ddb3ee712e4e7aa8e3a6b288f33b37"

### function for cookie statements
...
@app.route("/")
#get custom headlines, based on user input
def home():
    ...
    # get customized currency based on user inpuy
...
def get_rate(frm, to):
    ...
    # this calculatest the 2 conditions
